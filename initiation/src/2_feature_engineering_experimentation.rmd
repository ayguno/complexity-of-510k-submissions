...
# Export this feature list into token_dict_DEVICENAME.csv to engineer and experiment features
write.csv(data.frame(tokens = f_union, stringsAsFactors = FALSE),"../../feature_engineering/feature_store/token_dict_DEVICENAME.csv",row.names = FALSE)
```
